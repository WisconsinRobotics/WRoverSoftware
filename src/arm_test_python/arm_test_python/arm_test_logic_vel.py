...
class ArmLogic(Node):
    ...
    def __init__(self):
        ...
        self.arm_publisher_wrist_left = self.create_publisher(Float64, 'arm_wrist_left_vel', 10)
        self.arm_publisher_wrist_right = self.create_publisher(Float64, 'arm_wrist_right_vel', 10)
