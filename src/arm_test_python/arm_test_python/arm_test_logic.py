...
class ArmLogic(Node):
    ...
    def timer_callback(self):
        ...
        self.arm_publisher_wrist_left.publish(self.msg_wrist_right)
    ...
    def get_wrist_speeds(self, up, down, left, right):
    ...
    def get_gripper_speed(self, a, b):
        if a == 1:
    ...
    def listener_callback_joy(self, msg):
        ...
        self.msg_wrist_left.data = wrist_speeds[0]

        self.msg_wrist_right = Float64()
        self.msg_wrist_right.data = wrist_speeds[1]

        self.msg_gripper = Float64()
        self.msg_gripper.data = gripper_speed
