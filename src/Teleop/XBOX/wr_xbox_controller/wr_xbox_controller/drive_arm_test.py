...
class XboxPublisher(Node):
    ...
    def __init__(self):
        super().__init__('xbox_publisher_arm')
        self.swerve_publisher_ = self.create_publisher(Float32MultiArray, 'arm_test', 10)
    ...
    def timer_callback(self):
        ...
        if len(self.joysticks) > 0:
            ...
            motion = [-self.joysticks[1].get_axis(1),
                        self.joysticks[1].get_axis(3),
                        self.joysticks[1].get_axis(2),
                        self.joysticks[1].get_axis(5) ]
