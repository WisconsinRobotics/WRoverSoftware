...
: ${AMENT_CURRENT_PREFIX:="/workspace/install/urdf_visualization"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/urdf_visualization/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/urdf_visualization/environment/path.sh"
